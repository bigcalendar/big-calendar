...
beforeAll(() => {
  ...
  loc = createLuxonLocalizer({ ...NY, output: 'offset' })
  extended = createLuxonLocalizer({ ...NY, extendedZone: true, output: 'offset' })
})

describe('LuxonLocalizer — parsing & serialization', () => {
...
describe('LuxonLocalizer — output modes', () => {
  let utc: LuxonLocalizer
  let utcExtended: LuxonLocalizer
  beforeAll(() => {
    utc = createLuxonLocalizer(NY) // default output: 'utc'
    utcExtended = createLuxonLocalizer({ ...NY, extendedZone: true })
  })
...
describe('LuxonLocalizer — DST awareness', () => {
...
describe('LuxonLocalizer — week, slots & events', () => {
