/**
 * Composition-mode localizer bridge + direct-access toolbar decorator for the
 * Angular Storybook ref.
 *
 * Works in two modes:
 * - **Direct access** (localhost:6009 standalone): `context.globals` is live;
 ...
 *   uses them instead of Angular's own (default) globals on the next render.
 *
...
export const withAngularLocalizerDecorator: Decorator = (storyFn, context) => {
