...
<Popover placement="bottom-start" sameWidth className="bc-popover bc-show-more-popover">
  {#snippet trigger({ bindAnchor, popoverTarget, ariaHaspopup, ariaExpanded, ariaControls })}
    <button
      ...
      type="button"
      style="display:flex;align-items:center;justify-content:flex-end;inline-size:100%;block-size:100%;font-size:0.75em;color:rebeccapurple;text-decoration:underline;cursor:pointer;padding-inline:3px;background:none;border:none;"
    >
      {count} more ›
    </button>
  {/snippet}
