# DECISIONS — Archive (Phase 0–Phase 7)

> Phase 8+ decisions live in the active `DECISIONS.md`.
...
| DnD Phase 5 open: architecture, core/dnd/react split, move (5a), async lifecycle | 2026-06-07, 2026-06-08 Phase 5 |
| DnD 5b/5c/5c-preview: time-grid move, resize, live drag preview | 2026-06-08 Phase 5 |
| DnD 5d: cross-boundary drop (native HTML5 correction — Pragmatic "external" ≠ same-page) | 2026-06-08 Phase 5 |
| DnD 5e/5g: keyboard modal grab (time-grid + month), pointer move preview, month resize | 2026-06-08 Phase 5 |
| DnD Phase-5 tail: resource columns 1a–1c, timed↔all-day one-way promotion | 2026-06-08, 2026-06-09 Phase 5 |
| Phase 7a/7b split; hook extraction + element-spread pattern; public subpath exports | 2026-06-10 Phase 7 |
| Phase 7a: views/viewDefinitions rename, components.views unified dispatch, tree-shaking paths | 2026-06-10 Phase 7 |
