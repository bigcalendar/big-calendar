 ...
 *   2. Spawn the core hub   (port 6007) once the slave is ready.
 *   3. Wait for the hub to finish compiling, then open the browser.
 *
 * The hub reads its refs at startup — if the slave isn't already serving
